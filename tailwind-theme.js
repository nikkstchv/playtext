...
export default {
  ...
  'family:box': {
    decorator:
      'block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-indigo-500 text-transparent peer-checked:text-indigo-500',
    decoratorIcon:
  ...
  'family:dropdown': {
    ...
    inner:
      'max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-indigo-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-indigo-500',
    input: 'w-full px-3 py-2',
    listbox: 'bg-white shadow-lg rounded overflow-hidden',
    listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
    listitem:
      'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-indigo-600 aria-selected:bg-indigo-600 aria-selected:text-white',
    loaderIcon: 'ml-auto',
    loadMoreInner:
  ...
  'family:text': {
    inner:
      'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-indigo-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-indigo-500 rounded mb-1',
    input:
  ...
  select: {
    inner:
      'flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-indigo-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-indigo-500',
    input:
  ...
  textarea: {
    inner:
      'flex max-w-md rounded mb-1 ring-1 ring-gray-400 focus-within:ring-indigo-500 [&>label:first-child]:focus-within:text-indigo-500',
    input:
